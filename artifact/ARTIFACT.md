...
- [How to run](#how-to-run)
  ...
  - [Step III: Adaptation with selected pseudo-labels](#step-iii-adaptation-with-selected-pseudo-labels-48-hrs)
...
### Step III: Adaptation with selected pseudo-labels (~4.8 hrs)
...
**Total estimated runtime: ~5.1 hours** (Step I + Step II + all Step III variants above).
