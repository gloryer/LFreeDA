...
```
> [!TIP]
> If you're using VS Code (including over SSH), skip the command above — install the **Jupyter** extension (ms-toolsai.jupyter) if you haven't, then open the `.ipynb` file directly in the editor.
