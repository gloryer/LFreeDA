...
- [How to run](#how-to-run)
  ...
  - [Step III: Adaptation with selected pseudo-labels](#step-iii-adaptation-with-selected-pseudo-labels-50-hrs)
...
### Step III: Adaptation with selected pseudo-labels (~5.0 hrs)
...
**Total estimated runtime: ~5.3 hours** (Step I + Step II + all Step III variants above).
