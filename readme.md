...
Install the **Jupyter** extension in VS Code first. If you're sshed into a remote server or pod, the most convenient way to run these notebooks is to open the `.ipynb` file directly in the editor.
