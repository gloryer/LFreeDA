...
# `python StepI/train_mb24+_dec.py` from the repo root or `python
# train_mb24+_dec.py` from inside StepI/.
...
if __name__ == "__main__":
    ...
    label_path = DATA_DIR + "/labels/mb24/Dec/dec_malware.csv"
    img_path = DATA_DIR + "/image_features/mb24/dec/dec"
    ...
    print("  Target train = Nov malware+benign (labels discarded; used *unlabeled* for domain adaptation, see StepI/model.py)")
    print("  Target test  = Dec malware+benign (held out; this task's evaluation target)")
