...
# `python StepI/train_mb24+_aug.py` from the repo root or `python
# train_mb24+_aug.py` from inside StepI/.
...
if __name__ == "__main__":
    ...
    label_path = DATA_DIR + "/labels/mb24/July/july_malware.csv"
    img_path = DATA_DIR + "/image_features/mb24/july/july"
    malware_july_x, malware_july_y = load_image_malware(img_path, label_path)

    label_path = DATA_DIR + "/labels/mb24/Aug/aug_malware.csv"
    img_path = DATA_DIR + "/image_features/mb24/aug/aug"
    ...
    print("  Target train = July malware+benign (labels discarded; used *unlabeled* for domain adaptation, see StepI/model.py)")
    print("  Target test  = Aug malware+benign (held out; this task's evaluation target)")
    ...
    for i in range(1):
        ...
        # save_dir = REPO_ROOT + "/results/stepI_trained_models_scratch/mb24/aug"
