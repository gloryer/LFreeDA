...
# `python StepI/train_mb24+_nov.py` from the repo root or `python
# train_mb24+_nov.py` from inside StepI/.
...
if __name__ == "__main__":
    ...
    label_path = DATA_DIR + "/labels/mb24/Nov/nov_malware.csv"
    img_path = DATA_DIR + "/image_features/mb24/nov/nov"
    ...
    print("  Target train = Oct malware+benign (labels discarded; used *unlabeled* for domain adaptation, see StepI/model.py)")
    print("  Target test  = Nov malware+benign (held out; this task's evaluation target)")
