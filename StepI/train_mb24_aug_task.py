...
from utils import load_image_malware_mb24, load_image_normal, change_attack_label
...
if __name__ == "__main__":
    ...
    target_normal_train_x, re_normal_x, target_normal_train_y, re_normal_y = train_test_split(target_normal_x, target_normal_y, test_size=0.67, random_state=42)
    target_normal_test_x, x_, target_normal_test_y, y_ = train_test_split(re_normal_x, re_normal_y, test_size=0.5, random_state=42)
