...
if __name__ == "__main__":
    ...
    path = '../../../data/stepII_constructed_datasets/mb24/oct/source_train.npz'
    source_train = load_matched_graphs(path, "source_path_train", "source_y_train","source_y_train")



    #Load source test data
    path = "../../../data/stepII_constructed_datasets/mb24/oct/source_test.npz"
    ...
    path = '../../../data/stepII_constructed_datasets/mb24/oct/target_train_filtered.npz'
    ...
    path = "../../../data/stepII_constructed_datasets/mb24/oct/target_test.npz"
