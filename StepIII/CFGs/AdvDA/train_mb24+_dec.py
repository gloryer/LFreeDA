...
if __name__ == "__main__":
    ...
    path = str(project_root / 'data/stepII_constructed_datasets/mb24/dec/source_test.npz')
    ...
    path = str(project_root / 'data/stepII_constructed_datasets/mb24/dec/target_train_filtered.npz')
