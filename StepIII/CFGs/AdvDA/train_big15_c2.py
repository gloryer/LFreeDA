...
if __name__ == "__main__":
    ...
    path = '../../../data/stepII_constructed_datasets/big15/C2/source_train.npz'

    source_train = load_matched_graphs(path, "source_path_train", "source_y_train","source_y_train")


    #Load source test data
    path = "../../../data/stepII_constructed_datasets/big15/C2/source_test.npz"
    ...
    path = '../../../data/stepII_constructed_datasets/big15/C2/target_train_filtered.npz'
    ...
    path = "../../../data/stepII_constructed_datasets/big15/C2/target_test.npz"
