...
from GraphMatching.big15 import load_matched_graphs
...
if __name__ == "__main__":
    ...
    path = '../../../data/stepII_constructed_datasets/big15/C1/source_train.npz'

    source_train = load_matched_graphs(path, "source_path_train", "source_y_train","source_y_train")


    #Load source test data
    path = "../../../data/stepII_constructed_datasets/big15/C1/source_test.npz"
    ...
    path = '../../../data/stepII_constructed_datasets/big15/C1/target_train_filtered.npz'
    ...
    path = "../../../data/stepII_constructed_datasets/big15/C1/target_test.npz"
    ...
    n_out = target_train_filtered.n_labels
