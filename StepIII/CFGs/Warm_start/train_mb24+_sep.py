...
if __name__ == "__main__":
    ...
    path = "../../../data/stepII_constructed_datasets/mb24/sep/source_test.npz"
    ...
    path = '../../../data/stepII_constructed_datasets/mb24/sep/target_train_filtered.npz'
    ...
    path = "../../../data/stepII_constructed_datasets/mb24/sep/target_test.npz"
