...
if __name__ == "__main__":
    ...
    label_path = str(project_root / "data/labels/mb24/Aug/benign_source_dataset1.csv")
    img_path = str(project_root / "data/image_features/mb24/aug/aug")
    benign_source_dataset1_x, benign_source_dataset1_y = load_image_malware(img_path, label_path)

    label_path = str(project_root / "data/labels/mb24/Aug/benign_source_dataset2.csv")
    img_path = str(project_root / "data/image_features/mb24/aug/aug")
    benign_source_dataset2_x, benign_source_dataset2_y = load_image_malware(img_path, label_path)

    label_path = str(project_root / "data/labels/mb24/Aug/benign_source_dataset3.csv")
    img_path = str(project_root / "data/image_features/mb24/aug/aug")
    benign_source_dataset3_x, benign_source_dataset3_y = load_image_malware(img_path, label_path)

    label_path = str(project_root / "data/labels/mb24/Aug/benign_source_dataset4.csv")
    img_path = str(project_root / "data/image_features/mb24/aug/aug")
    ...
    label_path = str(project_root / "data/labels/mb24/Aug/benign_target_dataset1.csv")
    img_path = str(project_root / "data/image_features/mb24/aug/aug")
    benign_target_dataset1_x, benign_target_dataset1_y = load_image_malware(img_path, label_path)

    label_path = str(project_root / "data/labels/mb24/Aug/benign_target_dataset2.csv")
    img_path = str(project_root / "data/image_features/mb24/aug/aug")
    benign_target_dataset2_x, benign_target_dataset2_y = load_image_malware(img_path, label_path)

    label_path = str(project_root / "data/labels/mb24/Aug/benign_target_dataset3.csv")
    img_path = str(project_root / "data/image_features/mb24/aug/aug")
    benign_target_dataset3_x, benign_target_dataset3_y = load_image_malware(img_path, label_path)

    label_path = str(project_root / "data/labels/mb24/Aug/benign_target_dataset4.csv")
    img_path = str(project_root / "data/image_features/mb24/aug/aug")
