...
if __name__ == "__main__":
    ...
    data = np.load('../../../data/stepII_constructed_datasets/big15/C0/source_train.npz', allow_pickle=True)
    ...
    data = np.load('../../../data/stepII_constructed_datasets/big15/C0/source_test.npz', allow_pickle=True)
    ...
    data = np.load('../../../data/stepII_constructed_datasets/big15/C0/target_train_filtered.npz', allow_pickle=True)
    ...
    data = np.load('../../../data/stepII_constructed_datasets/big15/C0/target_test.npz', allow_pickle=True)
