...
if __name__ == "__main__":
    ...
    data = np.load(project_root / 'data/stepII_constructed_datasets/mb24/oct/source_train.npz', allow_pickle=True)
    ...
    data = np.load(project_root / 'data/stepII_constructed_datasets/mb24/oct/source_test.npz', allow_pickle=True)
    ...
    data = np.load(project_root / 'data/stepII_constructed_datasets/mb24/oct/target_train_filtered.npz', allow_pickle=True)
    ...
    data = np.load(project_root / 'data/stepII_constructed_datasets/mb24/oct/target_test.npz', allow_pickle=True)
