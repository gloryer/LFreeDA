...
if __name__ == "__main__":
    ...
    data = np.load('../../../data/stepII_constructed_datasets/mb24/july_task/source_train.npz', allow_pickle=True)
    ...
    data = np.load('../../../data/stepII_constructed_datasets/mb24/july_task/source_test.npz', allow_pickle=True)
    ...
    data = np.load('../../../data/stepII_constructed_datasets/mb24/july_task/target_train_filtered.npz', allow_pickle=True)
    ...
    data = np.load('../../../data/stepII_constructed_datasets/mb24/july_task/target_test.npz', allow_pickle=True)
